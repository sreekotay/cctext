...
- **Line-1 `#!ccc` headers** copy the TU into a cache dir; quoted `#include` of project `.cch` files then miss the source tree. Sources use suffix kind + `version=0.3.3` on the `ccc` line.
