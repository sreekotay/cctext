...
CC_TARGET_DEPS perf_matrix_smoke rtx_piece_tree rtx_hex rtx_grid rtx_nav rtx_scope rtx_find
...
CC_TARGET_DEPS tm_grammar_smoke rtx_piece_tree rtx_hex rtx_grid rtx_nav rtx_scope rtx_find

CC_TARGET tm_lookback_probe exe tests/tm_lookback_probe.ccs
CC_TARGET_INCLUDE tm_lookback_probe .
CC_TARGET_DEPS tm_lookback_probe rtx_piece_tree rtx_hex rtx_grid rtx_nav rtx_scope rtx_find

CC_TARGET pair_page_probe exe tests/pair_page_probe.ccs
CC_TARGET_INCLUDE pair_page_probe .
CC_TARGET_DEPS pair_page_probe rtx_piece_tree rtx_hex rtx_grid rtx_nav rtx_scope rtx_find
...
CC_TARGET_DEPS cctext rtx_piece_tree rtx_hex rtx_grid rtx_browse rtx_nav rtx_scope rtx_find rtx_ui_help rtx_cctext_draw rtx_cctext_input rtx_cctext_osx
